...
var arrow_animation_duration, arrow_animation_easing, arrows_in, arrows_out, current_step, display_lens, goto_step_0, goto_step_1, goto_step_2, goto_step_3, goto_step_4, goto_step_5, goto_step_6, goto_step_7, goto_step_minus_1, page_init, zoom_duration;
...
goto_step_5 = function() {
  if (current_step === 4) {
    ...
    display_lens(5);
    $('.circle-girlback-container').hover(function() {
      return $('.preview-box').stop(true).fadeIn();
    }, function() {
      return $('.preview-box').stop(true).fadeOut();
    });
    return $('.circle-girlback-container').click(function() {
      return goto_step_6();
    });
  }
};
...
goto_step_6 = function() {
  if (current_step === 5) {
    ...
    return $('.picture-container2').fadeOut(zoom_duration);
  }
};
