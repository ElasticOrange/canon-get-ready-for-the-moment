var arrow_animation_duration, arrow_animation_easing, arrows_in, arrows_out, current_step, goto_step_0, goto_step_1, goto_step_2, page_init;
    ...
    return $('.grey-container').fadeOut(greyoverlay_fadeout_duration, function() {
      return $('.picture-container').animate({
        ...
        return $('.obiectiv-kit').fadeOut(400, function() {
          ...
          return $('.text-container').html(_.template($('#texts-wide').html()));
        });
      });
    });
  }
